...
export default function home() {
    ...
    return `
      ...
      <form class="form" id="formulariohome">
          ...
          <fieldset class="radio-image escolhaIcone">
              <label for="A">
                  <img src=".././banner/1.jpg" id="um" onclick="pegar(this)" alt="facebook" class="escolhaa"
                      height="45px">
              </label>

              <label for="B">
                  <img src=".././banner/2.jpg" id="dois" onclick="pegar(this)" alt="instagram" class="escolhaa"
                      height="45px">
              </label>

              <label for="C">
                  <img src=".././banner/3.jpg" id="tres" onclick="pegar(this)" alt="whatsapp" class="escolhaa"
                      height="45px">
              </label>
              <label for="D">
                  <img src=".././banner/4.jpg" id="quatro" onclick="pegar(this)" alt="youtube" class="escolhaa"
                      height="45px">
              </label>
              <label for="E">
                  <img src=".././banner/5.jpg" id="cinco" onclick="pegar(this)" alt="youtube" class="escolhaa"
                      height="45px">
              </label>
              <label for="F">
                  <img src=".././banner/6.jpg" id="seis" onclick="pegar(this)" alt="youtube" class="escolhaa"
                      height="45px">
              </label>
